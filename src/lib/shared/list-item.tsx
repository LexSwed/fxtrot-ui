...
interface ListItemProps extends ListItemVariants, FlexVariants {}
...
const listItemCssInner = css(styles['list-item'], flex, {
  variants: {
    size: {
      ...
      md: styles['list-item--md'],
      lg: styles['list-item--lg'],
    },
  },
});

export type ListItemVariants = VariantProps<typeof listItemCssInner>;

...
<Playground>
  <Flex flow="column" gap="lg" css={{ py: '$8', bc: '$gray50' }}>
    <Flex gap="md" css={{ px: '$10' }}>
      ...
      <IconButton size="xs" variant="flat">
        <Icon as={ArrowNarrowRightIcon} size="sm" />
      </IconButton>
    ...
    <Flex gap="md" css={{ px: '$10' }}>
      ...
      <IconButton size="md" variant="flat">
        <Icon as={ArrowNarrowRightIcon} />
      </IconButton>
      <IconButton size="md" variant="link">
        <Icon as={ArrowNarrowRightIcon} />
      </IconButton>
    </Flex>
    <Flex gap="md" css={{ px: '$10' }}>
      ...
      <IconButton size="lg" variant="flat">
        <Icon as={ArrowNarrowRightIcon} />
      </IconButton>
  ...
  <ThemeProvider theme="purple">
    <Flex flow="column" gap="xl" css={{ py: '$8', bc: '$surfaceStill' }}>
      ...
      <Flex gap="md" css={{ px: '$10' }}>
        ...
        <IconButton variant="link" disabled>
          <Icon as={ArrowNarrowRightIcon} />
        </IconButton>
      </Flex>
    </Flex>
